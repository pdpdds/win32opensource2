...
HANDLE PakInterface::FindFirstFile(LPCSTR lpFileName, LPWIN32_FIND_DATAA lpFindFileData)
{
...
BOOL PakInterface::FindNextFile(HANDLE hFindFile, LPWIN32_FIND_DATAA lpFindFileData)
{
