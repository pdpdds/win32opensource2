...
public:
	...
	virtual HANDLE			FindFirstFile(LPCSTR lpFileName, LPWIN32_FIND_DATAA lpFindFileData) = 0;	
	virtual BOOL			FindNextFile(HANDLE hFindFile, LPWIN32_FIND_DATAA lpFindFileData) = 0;
...
static HANDLE p_FindFirstFile(LPCSTR lpFileName, LPWIN32_FIND_DATAA lpFindFileData)
{
	if (GetPakPtr() != NULL)
...
static BOOL p_FindNextFile(HANDLE hFindFile, LPWIN32_FIND_DATAA lpFindFileData)
{
	if (GetPakPtr() != NULL)
